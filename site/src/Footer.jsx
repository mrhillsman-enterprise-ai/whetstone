    ...
    <footer className="footer">
      ...
      <div className="ws-wrap" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="ws-release-banner" style={{ marginBottom: 'var(--s-7)' }}>
          <span className="ver">v2.5.0</span>
          <div>
            <div className="title">
        ...
        <div className="row">
          <div className="col footer-mark">
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              <span className="ws-badge ws-badge--acid"><span className="pulse"></span>v2.5.0 · STABLE</span>
        ...
        <div className="meta">
          <span>// WHETSTONE · v2.5.0 · {new Date().getFullYear()}</span>
